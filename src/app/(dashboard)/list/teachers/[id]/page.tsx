  ...
  return (
   ...
   {/* USER INFO CARD */}
      <div className='bg-lamasky py-6 px-4 rounded-md flex-1 flex gap-4'>
        ...
        <h1 className='text-xl font-semibold'>Abubeker Oumer</h1>
        <p className='text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit.</p>
        <div className='flex  items-center justify-between gap-2 flex-wrap text-xs font-medium'>
           ...
           <div className='w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2'>
            ...
            <span>oumerelfaruke@gmail.com</span>
        </div>
           <div className='w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2'>
      ...
      <div className='bg-white p-4 rounded-md'>
        ...
        <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
          ...
          <Link className='p-3 rounded-md bg-yellow-100' href="/">Teacher's Exams</Link>
