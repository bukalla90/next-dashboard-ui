...
const TeacherForm = ({
  ...
  return (
    <form onSubmit={onSubmit} className="felx flex-col gap-8">
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.sex?.message && (
            <p className="text-xs text-blue-400">{errors.sex.message}</p>
          )}
        </div>
        <div className="flex flex-col gap-2 w-full md:w-1/4 justify-center">
          ...
          {errors.img?.message && (
            <p className="text-xs text-blue-400">{errors.img.message}</p>
          )}
        </div>
      </div>

      <button className="bg-blue-400 text-white p-2 rounded-md mt-4 w-full">
